...
input_file = (
    r"data\satellite\raw"
    r"\sentinel2_guwahati_2015_mosaic.tif"
)
...
output_file = os.path.join(
    output_dir,
    "sentinel2_guwahati_2015_processed.tif"
)
    ...
    with rasterio.open(
        ...
        **profile
        ...
        for chunk_number, row_start in enumerate(
            ...
            # Keep reflectance between 0 and 1
            data = np.clip(
                data,
                0,
                1
...
print()
print("=" * 70)
print("2015 PREPROCESSING COMPLETE")
print("=" * 70)
print(
    "Output:",
    output_file
